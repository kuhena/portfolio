...
$require = array('co-name','name','mail','tel','text');
...
$refrom_name = "KOOK HANNAH H";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせいただき、ありがとうございました。";
...
<title>My Room by kook hannah h</title>
...
<body>
  ...
  <header>
    <div class="header_inner">
      <div id="logo">
        <h1><img src="images/logo.jpg" alt="SG予備学院"></h1>
      </div>
    </div>
  </header>
<!-- Google Tag Manager -->
